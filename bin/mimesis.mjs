...
const commands = new Map([
  ...
  ["gate:evidence-issue-convert", { description: "Convert a Gate Evidence issue body into a draft evidence packet candidate.", type: "node", script: "tools/convert-gate-evidence-issue.mjs" }],
  ...
  ["owner:evidence-submission-issue-convert", { description: "Convert an owner evidence submission issue body into a bounded draft owner evidence submission record.", type: "node", script: "tools/convert-owner-evidence-submission-issue.mjs" }],
  ...
  ["owner:proof-input-remote-issue", { description: "Generate the remote owner proof input issue anchor packet.", type: "node", script: "tools/create-owner-proof-input-remote-issue-anchor.mjs" }],
  ["owner:proof-input-remote-issue-snapshot", { description: "Generate a metadata-only snapshot of the remote owner proof input issue.", type: "node", script: "tools/create-owner-proof-input-remote-issue-snapshot.mjs" }],
  ["owner:proof-input-remote-issue-export", { description: "Export candidate remote owner proof input issue body to a private gitignored path.", type: "node", script: "tools/export-owner-proof-input-remote-issue.mjs" }],
  ...
  ["owner:issue-queue", { description: "Generate copyable owner issue body drafts for the current open gates.", type: "node", script: "tools/create-owner-issue-queue.mjs" }],
  ["owner:issue-remote-sync", { description: "Generate a read-only sync snapshot between local gate issue drafts and remote GitHub issues.", type: "node", script: "tools/create-owner-issue-remote-sync.mjs" }],
  ["owner:issue-remote-create", { description: "Create missing remote GitHub gate issues only when called with --execute.", type: "node", script: "tools/create-owner-issue-remote-create.mjs" }],
  ...
  ["audit:gate-evidence-issue-convert", { description: "Audit Gate Evidence issue conversion into draft evidence packets.", type: "node", script: "tools/audit-gate-evidence-issue-convert.mjs" }],
  ...
  ["audit:owner-evidence-submission-issue-convert", { description: "Audit owner evidence submission issue conversion and no-closure boundaries.", type: "node", script: "tools/audit-owner-evidence-submission-issue-convert.mjs" }],
  ...
  ["audit:owner-issue-remote-create", { description: "Audit remote gate issue creation metadata and no-closure boundary.", type: "node", script: "tools/audit-owner-issue-remote-create.mjs" }],
