...
| 4 | `strict_publish_sync` | Strict publish sync gate | blocked | Clean or intentionally publish local changes, then rerun the strict sync gate. | `npm run audit:sync` | Does not stage, commit, push, tag, release, or publish. |
