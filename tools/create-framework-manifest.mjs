...
const manifest = {
  ...
  entrypoints: [
    ...
    {
      name: "gate evidence issue conversion",
      path: ".mimesis/gates/fixture-gate-evidence-packet.md",
      command: "npm run gate:evidence-issue-convert"
    },
    {
    ...
    {
      name: "owner evidence submission issue conversion",
      path: ".mimesis/owner-actions/fixture-owner-evidence-submission-issue-record.json",
      command: "npm run owner:evidence-submission-issue-convert"
    },
    {
  ...
  commands: [
    ...
    {
      name: "gate:evidence-issue-convert",
      purpose: "Convert a Gate Evidence issue body into a draft evidence packet candidate without reviewing evidence or closing gates."
    },
    {
      name: "audit:gate-evidence-issue-convert",
      purpose: "Check Gate Evidence issue conversion, fixture output, evidence packet structure, manifests, public docs, and no-proof/no-closure boundaries."
    },
    {
    ...
    {
      name: "audit:owner-proof-input-remote-issue-export-candidate",
    ...
    {
      name: "owner:evidence-submission-issue-convert",
      purpose: "Convert an owner evidence submission issue body into a draft owner evidence submission record candidate."
    },
    {
      name: "audit:owner-evidence-submission-issue-convert",
      purpose: "Check owner evidence submission issue conversion, fixture output, CLI, public docs, and no-closure boundaries."
    },
    {
      name: "owner:evidence-submission-check",
