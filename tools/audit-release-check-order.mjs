...
for (const [earlier, later] of [
  ...
  ["owner:issue-queue", "owner:decision-intake"],
  ["owner:issue-queue", "owner:proof-handoff"],
  ...
  ["audit:gate-evidence-packet", "audit:gate-evidence-issue-form"],
  ["audit:gate-evidence-issue-form", "audit:gate-evidence-issue-convert"],
  ["audit:gate-evidence-issue-form", "audit:release-artifact-manifest"],
  ...
  ["audit:owner-issue-remote-sync", "audit:owner-decision-intake"],
  ...
  ["audit:owner-issue-queue", "audit:owner-decision-intake"],
  ["audit:owner-issue-queue", "audit:owner-proof-handoff"],
  ...
  ["audit:owner-proof-input-remote-issue-export", "audit:owner-proof-input-remote-issue-export-candidate"],
  ["audit:owner-proof-input-remote-issue-export-candidate", "audit:owner-proof-input-issue-convert"],
  ["audit:owner-proof-input-remote-issue-export-candidate", "audit:owner-proof-input-private-pipeline"],
  ["audit:owner-proof-input-remote-issue-export-candidate", "audit:release-artifact-manifest"],
  ...
  ["audit:owner-proof-input-issue-convert", "audit:owner-proof-input-private-pipeline"],
  ["audit:owner-proof-input-review", "audit:owner-proof-input-split"],
  ["audit:owner-proof-input-review", "audit:owner-proof-input-private-pipeline"],
  ...
  ["audit:owner-proof-input-split", "audit:owner-proof-input-private-pipeline"],
  ["audit:owner-proof-input-private-pipeline", "audit:owner-evidence-submission-record"],
  ["audit:owner-proof-input-private-pipeline", "audit:release-artifact-manifest"],
